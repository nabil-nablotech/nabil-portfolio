...
function LandingUI({ theme, drawerOpen, classes, language }) {
  return (
      ...
      <div className="landing--container">
          ...
          <div className="lcl--content">
            ...
            {contactsData.telegram && (
              <a href={contactsData.telegram} target="_blank" rel="noreferrer">
                <FaTelegram
                  className="landing--social telegram-icon"
                  style={{ color: theme.primary }}
                  aria-label="Telegram"
                />
              </a>
            ...
            {contactsData.whatsapp && (
              <a href={contactsData.whatsapp} target="_blank" rel="noreferrer">
                <FaWhatsapp
                  className="landing--social whatsapp-icon"
                  style={{ color: theme.primary }}
                  aria-label="whatsapp"
                />
              </a>
        ...
        >
          <div className="lcr--content" style={{ color: theme.tertiary }}>
            ...
            <Typed
              strings={headerData.strings[language]}
              typeSpeed={40}
              backSpeed={50}
              ...
              loop
            />
            <p>{headerData.desciption[language]}</p>
              ...
              {headerData.resumePdf && (
                ...
                >
                  <button className={classes.resumeBtn}>
                    {headerData.callToAction[language]}
                  </button>
                </a>
              )}
              <NavLink to="/#contacts" smooth={true} spy="true" duration={2000}>
                <button className={classes.contactBtn}>
                  {headerData.contact[language]}
                </button>
              </NavLink>
            </div>
          </div>
