...
```
git clone https://github.com/<YOUR GITHUB USERNAME>/nabil-portfolio.git
...
```
git clone -b typescript-version https://github.com/<YOUR GITHUB USERNAME>/nabil-portfolio.git
